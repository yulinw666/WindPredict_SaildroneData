# -*- coding: utf-8 -*-
"""
15E_VH_joint_VesselHDG_GatedResidual_alpha_v2.py
...
def main():
    ...
    parser.add_argument(
        "--ridge-alpha",
        type=float,
        default=OLD_RIDGE_ALPHA,
        help="Joint Ridge regularization coefficient for the motion anchor.",
    )
    ...
    globals()["OLD_RIDGE_ALPHA"] = ridge_alpha
    ...
    # fit_old_joint_ridge() reads OLD_RIDGE_ALPHA from the helper module.
    emod.OLD_RIDGE_ALPHA = float(OLD_RIDGE_ALPHA)
    ...
    log("")
    log(
        f"[STAGE 3/6] Rebuilding old joint Ridge alpha={OLD_RIDGE_ALPHA:.12g}."
    )
