# -*- coding: utf-8 -*-
"""
15C_D3_train_1min_VesselHDG_Residual_ApparentWind_3LayerGRU.py
...
Ablation purpose
----------------
This is the 3-layer GRU depth-ablation version of Stage15C.

For a strict comparison against the 1-layer and 2-layer variants, the
...
This allows a clean GRU-depth ablation:
    1 layer vs 2 layers vs 3 layers.

Recommended PowerShell
----------------------
python "D:\\project\\WindPredict_SaildroneData\\src\\15C_D3_train_1min_VesselHDG_Residual_ApparentWind_3LayerGRU.py" --dataset-dir "D:\\project\\WindPredict_SaildroneData\\data\\forecasting\\SD1090_TPOS2024_JointForecasting_v0_1" --stage15b-dir "D:\\project\\WindPredict_SaildroneData\\data\\forecasting\\15B_F_1min_TrueWind_Residual_v0_3" --stage15a-vessel-dir "D:\\project\\WindPredict_SaildroneData\\data\\forecasting\\15A_F_VesselHDG_alpha2250_v0_3" --output-dir "D:\\project\\WindPredict_SaildroneData\\data\\forecasting\\15C_D3_1min_VesselHDG_ApparentResidual_3LayerGRU_v0_1"
"""
...
DEFAULT_OUTPUT_DIR = (
    ...
    / "data"
    / "forecasting"
    / "15C_D3_1min_VesselHDG_ApparentResidual_3LayerGRU_v0_1"
)
...
def main():
    ...
    log("=" * 150)
    log(
        "15C-D3 — STEP 3: VESSEL/HDG RESIDUAL + APPARENT-WIND PHYSICAL COUPLING"
    )
    log("=" * 150)
    ...
    log(
        f"Residual network: 3-layer GRU, hidden={GRU_HIDDEN}"
    )
    ...
    log("")
    log(
        "[STAGE 4/8] Training 3-layer Vessel/HDG residual GRU."
    )
    ...
    metrics.to_csv(
        out
        / "15C_D3_metrics_per_horizon.csv",
        index=False,
        encoding="utf-8-sig",
    )
    ...
    np.savez_compressed(
        out
        / "15C_D3_validation_predictions.npz",
    ...
    checkpoint_path = (
        out
        / "15C_D3_vessel_hdg_residual_3layer_gru.pt"
    )
    ...
    with (
        ...
        f.write(
            "15C-D3 — 3-LAYER GRU VESSEL/HDG RESIDUAL + APPARENT-WIND COUPLING\n"
        )
    ...
    log("=" * 150)
    log(
        "15C-D3 3-LAYER GRU FINAL TEST — VESSEL/HDG + APPARENT WIND"
    )
    log("=" * 150)
