...
SCRIPT_VERSION = "0.2.1-12Xv2-GlobalRidge-LocalSafeResidual-TestFilenameFix"
...
def mission_path(
    ...
    """
    Resolve Stage-12G mission NPZ names.

    Development missions use:
        Antarctic.npz
        Atlantic.npz
        West_Coast.npz

    Stage-12G labels the final Tropical test file as:
        Tropical_Atlantic_TEST.npz

    For robustness, Tropical Atlantic first resolves the canonical _TEST file
    and then falls back to the plain name if a legacy copy exists.
    """
    track_dir = (
        dataset_root
        / "track_J_joint_compatible"
