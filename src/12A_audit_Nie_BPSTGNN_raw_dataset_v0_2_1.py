...
SCRIPT_VERSION = "0.2.1-Nie-raw-data-recursive-mission-audit"
...
def main():
    ...
    log("=" * 122)
    log("12A v0.2 - NIE/BP-STGNN RAW DATASET RECURSIVE MISSION AUDIT")
    log("=" * 122)
    ...
    with (
        ...
        f.write(
            "12A v0.2 Nie/BP-STGNN Raw Dataset Mission Audit\n"
        )
        f.write(
            "="
            * 122
    ...
    log(
        f"[DONE] 12A v0.2 outputs: {output_dir}"
    )
